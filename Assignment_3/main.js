...
formData.addEventListener("submit", function (ev) {
    ...
    var resume = "\n    <div id=\"res_header\"><h1>".concat(name, "</h1>\n    <p id=\"add\">").concat(address, "</p>\n    <p id=\"contact\"><b>Cell No # </b>").concat(cellNo, " | <b>Email:</b>").concat(email, "</p>\n    </div>\n    <br />\n    <h3>PROFESSIONAL SUMMARY</h3>\n    <p>Highly Skilled and result oriented professional with solid academic preparation and extensive experience \n    in intelligence and multi-faceted background seeks a position in office management. Proven ability to \n    access and manage complex obstacles viewed as a strong troubleshooter.</p>\n    <br />\n    <h3>WORK HISTORY</h3>\n    <ol>\n    <li>\n        <p><b>").concat(company_1, " | ").concat(designation_1, " (").concat(startDate_1, " to ").concat(endDate_1, ")</b></p>\n            <p>Worked as a ").concat(designation_1, "</p>   \n    </li>\n\n    <li>\n        <p><b>").concat(company_2, " | ").concat(designation_2, " (").concat(startDate_2, " to ").concat(endDate_2, ")</b></p>\n            <p>Worked as a ").concat(designation_2, "</p>   \n    </li>\n\n    <li>\n        <p><b>").concat(company_3, " | ").concat(designation_3, " (").concat(startDate_3, " to ").concat(endDate_3, ")</b></p>\n            <p>Worked as a ").concat(designation_3, "</p>   \n    </li>\n    </ol>\n    <br />\n\n    <h3>EDUCATION</h3>\n    <ul><li><p>").concat(university_1, " | ").concat(degree_1, " (").concat(passingY_1, ")</p></ul></li>\n    <ul><li><p>").concat(university_2, " | ").concat(degree_2, " (").concat(passingY_2, ")</p></ul></li>\n    <ul><li><p>").concat(university_3, " | ").concat(degree_3, " (").concat(passingY_3, ")</p></ul></li>\n    <br />\n\n    <h3>SKILLS SECTION</h3>\n    <ul><li>").concat(skill_1, "</ul></li>\n    <ul><li>").concat(skill_2, "</ul></li>\n    <ul><li>").concat(skill_3, "</ul></li>\n    <ul><li>").concat(skill_4, "</ul></li>\n    ");
    if (res_Display) {
