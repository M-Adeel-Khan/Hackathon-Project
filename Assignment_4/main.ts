...
formData.addEventListener("submit",(ev:SubmitEvent)=>{
    ...
    const resume = `
    <div id="res_header"><h1 contenteditable="true">${name}</h1>
    <p id="add" contenteditable="true">${address}</p>
    <p id="contact" contenteditable="true"><b>Cell No # </b>${cellNo} | <b>Email:</b>${email}</p>
    </div>
    <br />
    ...
    <ol>
    <li>
        <p contenteditable="true"><b>${company_1} | ${designation_1} (${startDate_1} to ${endDate_1})</b></p>
            <p>Worked as a ${designation_1}</p>   
    </li>

    <li>
        <p contenteditable="true"><b>${company_2} | ${designation_2} (${startDate_2} to ${endDate_2})</b></p>
            <p>Worked as a ${designation_2}</p>   
    </li>

    <li>
        <p contenteditable="true"><b>${company_3} | ${designation_3} (${startDate_3} to ${endDate_3})</b></p>
    ...
    <h3>EDUCATION</h3>
    <ul><li><p contenteditable="true">${university_1} | ${degree_1} (${passingY_1})</p></ul></li>
    <ul><li><p contenteditable="true">${university_2} | ${degree_2} (${passingY_2})</p></ul></li>
    <ul><li><p contenteditable="true">${university_3} | ${degree_3} (${passingY_3})</p></ul></li>
    <br />

    <h3>SKILLS SECTION</h3>
    <ul><li contenteditable="true">${skill_1}</ul></li>
    <ul><li contenteditable="true">${skill_2}</ul></li>
    <ul><li contenteditable="true">${skill_3}</ul></li>
    <ul><li contenteditable="true">${skill_4}</ul></li>
    `;
